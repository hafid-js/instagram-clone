            ...
            <div className="h-[70vh] justify-between pb-5 flex">
              ...
              <div className='w-[50%]'>
                <div className='flex items-center px-2'>
                    <img className='w-7 h-7 rounded-full' src='https://cdn.pixabay.com/photo/2024/03/02/09/14/bridge-8608105_1280.jpg' alt=''/>
                    <p className='font-semibold ml-4'>hafid.js</p>
                </div>
                <div className="px-2">
                    <textarea
